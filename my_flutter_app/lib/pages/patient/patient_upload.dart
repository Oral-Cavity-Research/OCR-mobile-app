...
class _PatientConsentFormState extends State<PatientConsentForm> {
  ...
  final TextEditingController systemicDiseaseController =
      TextEditingController();
    ...
    pdf.addPage(
      pw.Page(
        build: (pw.Context context) => pw.Column(
          ...
          children: [
            pw.Text("Patient Data Collection Consent Form",
                style:
            ...
            pw.RichText(
              text: pw.TextSpan(
                ...
                children: [
                  pw.TextSpan(
                      text: patientNameController.text,
                      style: pw.TextStyle(
                          fontWeight: pw.FontWeight.bold,
                          color: PdfColors.blue900)),
                  pw.TextSpan(
                      text:
                          " [${patientIdController.text}], hereby consent to the collection of my personal health information by OCR Tool for the purpose of data collection and analysis."),
                ],
              ),
            ),
            pw.SizedBox(height: 20),
            pw.Text(
                "The personal health information that will be collected includes:",
                style: pw.TextStyle(fontSize: 14)),
            pw.Bullet(
                text:
            ...
            pw.Bullet(
                text: "Medical history and diagnosis information",
                style: pw.TextStyle(fontSize: 12)),
            pw.Bullet(
                text: "Treatment and medication information",
                style: pw.TextStyle(fontSize: 12)),
            pw.Bullet(
                text: "Laboratory and diagnostic test results",
                style: pw.TextStyle(fontSize: 12)),
            pw.Bullet(
                text: "Intraoral and Extraoral photographs",
                style: pw.TextStyle(fontSize: 12)),
            pw.SizedBox(height: 20),
            pw.Text(
            ...
            pw.Row(
              ...
              children: [
                ...
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    pw.Text("Signature: ${patientNameController.text}",
                        style: pw.TextStyle(fontSize: 12)),
                    pw.Text(
  ...
  Future<void> _submitForm(BuildContext context, File file) async {
    if (_formKey.currentState!.validate() && file != null) {
      List<RiskFactors> ParseRiskFactors(
        ...
        return controllers
            .where((controller) =>
                controller.text.isNotEmpty) // Filter out empty fields
            .map((controller) {
      ...
      PatientModelRequest patientData = PatientModelRequest(
        ...
        medicalHistory: medicalHistoryController.text
            .split(',')
            .map((e) => e.trim())
            .toList(), // Assuming comma-separated values
      ...
      final responseCode = await patientUploadService()
          .createPatient(patientData, file, patientData.patientId);

      if (responseCode == 200) {
        print('ConsentForm uploaded successfully');
        await responsePopup(
            context, "Success", "ConsentForm uploaded successfully!");
      } else {
            ...
            child: ListView(
              children: [
                ...
                TextFormField(
                  ...
                  decoration:
                      InputDecoration(labelText: "Histological Diagnosis"),
                ...
                TextFormField(
                  ...
                  validator: (value) =>
                      value!.isEmpty ? "Medical History is required" : null,
                ),
                // Family History (comma-separated)
                TextFormField(
                  controller: familyHistoryController,
                  decoration: InputDecoration(
                      labelText: "Family History (comma-separated)"),
                  validator: (value) =>
                      value!.isEmpty ? "Family History is required" : null,
                ),
                // Systemic Disease
                TextFormField(
                  ...
                  validator: (value) =>
                      value!.isEmpty ? "Systemic Disease is required" : null,
                ),
                // Contact Number
                TextFormField(
